  ...
  return (
    <div className="bg-wheat-800 h-screen w-screen flex flex-col justify-between">
      <div className='flex justify-between p-6'>
        ...
        <Link to='/signin'>
          <h4 className='border border-gray-300 rounded-full px-5 py-2 font-semibold'>Login</h4>
        </Link>
      </div>
      ...
      <div className='items-center justify-center md:px-30 md:py-20 p-10 m-auto rounded-lg'>
        ...
        <h4 className='text-lg text-[#7E7E7E] mx-auto text-center'>Your personal finance assistant</h4>
        <h4 className='text-lg text-[#7E7E7E] max-w-[270px] mx-auto text-center'>Get started by creating an account</h4>
        <div className='flex justify-center mt-10'>
        <Link to='/signup'>
          <button className='bg-purple-500 text-gray-300 px-10 md:px-10 py-2 rounded-full cursor-pointer font-semibold'>Get Started</button>
        </Link>
      </div>
    </div>
    </div>
